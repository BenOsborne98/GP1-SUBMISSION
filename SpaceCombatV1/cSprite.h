...
public:
	...
	cSprite(cTextures* theSpriteTexture);			// Default constructor
	~cSprite();			// Destructor
	...
	cTextures* getTexture();  // Return the sprites current image
	void setTexture(cTextures* theSpriteTexture);  // set the image of the sprite
