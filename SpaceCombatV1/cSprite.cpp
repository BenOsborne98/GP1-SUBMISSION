...
cSprite::cSprite(cTextures* theSpriteTexture) 			// Default constructor
{
...
cTextures* cSprite::getTexture()  // Return the sprites current image
{
...
void cSprite::setTexture(cTextures* theSpriteTexture)  // set the image of the sprite
{
	this->spriteTexture = theSpriteTexture;
