...
=================
*/
cTextures::cTextures(LPCSTR theFilename, SDL_Renderer *theRenderer)
{
	cTextures::loadTexture(theFilename, theRenderer);
}
...
=================
*/
bool cTextures::loadTexture(LPCSTR theFilename, SDL_Renderer *theRenderer) 	// create the texture for use.
{
...
bool cTextures::loadTexture(SDL_Texture* theTexture) 	// create the texture for use.
{
...
=================
*/
SDL_Texture* cTextures::getTexture()        // return the texture.
{
	return cTextures::sdlTextureID;
}
...
=================
*/
int cTextures::getTWidth() 						// Return width of texture;
{
	return textureWidth;
}
/*
...
=================
*/
int cTextures::getTHeight() 						// Return height of texture;
{
...
=================
*/
void cTextures::renderTexture(SDL_Renderer* theRenderer, SDL_Texture* ptheTexture, SDL_Rect* theSourceRect, SDL_Rect* theDestRect, FPoint theScaling)
{
	//SDL_RenderSetScale(theRenderer, theScaling.X, theScaling.Y);
	SDL_RenderCopy(theRenderer, ptheTexture, theSourceRect, theDestRect);
}

void cTextures::renderTexture(SDL_Renderer* theRenderer, SDL_Texture* ptheTexture, SDL_Rect* theSourceRect, SDL_Rect* theDestRect, double rotAngle, SDL_Point* spriteCentre, FPoint theScaling)
{
	//SDL_RenderSetScale(theRenderer, theScaling.X, theScaling.Y);
...
==========================================================================
*/
SDL_Rect cTextures::getTextureRect()
{
